...
const CheckInForm = () => {
  ...
  useEffect(() => {
    const fetchCheckIns = async () => {
      try {
        const res = await fetch("https://shivaamfarmsandresorts-villa-software-new.onrender.com/api/checkins");
  ...
  const openSearch = async () => {
    try {
      const res = await fetch("https://shivaamfarmsandresorts-villa-software-new.onrender.com/api/bookings");
      const data = await res.json();
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const fetchRes = await fetch("https://shivaamfarmsandresorts-villa-software-new.onrender.com/api/checkins");
